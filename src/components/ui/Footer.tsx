      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div>
            ...
            <ul className='space-y-2.5 text-sm text-gray-500'>
              <li>
                <a href='mailto:fudedevelopments@gmail.com' className='hover:text-blue-900 transition-colors'>
            ...
            <div className='flex gap-3 mt-5'>
              <a href='https://github.com/fudedevelopments' target='_blank' rel='noopener noreferrer' className='w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors' aria-label='GitHub'>
              ...
              <a href='https://www.linkedin.com/company/104111287' target='_blank' rel='noopener noreferrer' className='w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors' aria-label='LinkedIn'>
              ...
              <a href='https://instagram.com/fude_developments' target='_blank' rel='noopener noreferrer' className='w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors' aria-label='Instagram'>
              ...
              <a href='https://youtube.com/@fudedevelopments' target='_blank' rel='noopener noreferrer' className='w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors' aria-label='YouTube'>
        ...
        <div className='mt-10 pt-8 border-t border-gray-100 text-center'>
          <p className='text-sm text-gray-400'>
            &copy; {new Date().getFullYear()} Fude Development. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
