        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
          {features.map((feature, index) => (
            <ScrollReveal key={feature.title} delay={index * 100}>
              <div className='group relative bg-white border border-gray-100 rounded-2xl p-7 hover-lift h-full'>
                {/* Hover glow effect */}
                <div className='absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-50 to-amber-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
