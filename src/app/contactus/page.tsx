              ...
              <div className='bg-white border border-gray-100 rounded-2xl p-6 shadow-sm'>
                ...
                <div className='space-y-5'>
                  <div className='flex items-start gap-4'>
                    ...
                    <div>
                      ...
                      <a href='mailto:fudedevelopments@gmail.com' className='text-gray-900 hover:text-blue-900 transition-colors'>
                  ...
                  <div className='flex items-start gap-4'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-900'>Slatter Nagar, Perunduari</p>
                      <p className='text-gray-500 text-sm'>Erode - 638053, Tamil Nadu</p>
                    </div>
                  </div>
                </div>
                ...
                <div className='mt-6 pt-6 border-t border-gray-100'>
                  ...
                  <div className='flex gap-3'>
                    <a href='https://www.linkedin.com/company/104111287' target='_blank' rel='noopener noreferrer' className='w-10 h-10 bg-gray-50 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors' aria-label='LinkedIn'>
                    ...
                    <a href='https://instagram.com/fude_developments' target='_blank' rel='noopener noreferrer' className='w-10 h-10 bg-gray-50 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors' aria-label='Instagram'>
                    ...
                    <a href='https://youtube.com/@fudedevelopments' target='_blank' rel='noopener noreferrer' className='w-10 h-10 bg-gray-50 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors' aria-label='YouTube'>
                    ...
                    <a href='https://github.com/fudedevelopments' target='_blank' rel='noopener noreferrer' className='w-10 h-10 bg-gray-50 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors' aria-label='GitHub'>
